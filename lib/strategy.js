...
const checkResponseType = responseType => {
    ...
    throw new TypeError('AppleStrategy requires a valid responseType option("code" or "id_token")');
};

const makeResponseType = responseType => {
    if (responseType === undefined) {
        return 'code';
    }
    if (responseType === 'id_token') {
...
class AppleStrategy extends passport.Strategy {
    ...
    constructor(options = {}, verify) {
        ...
        checkResponseType(options.responseType);
        ...
        this._responseType = makeResponseType(options.responseType);
    ...
    authenticate(req, options = {}) {
        ...
        if (req.body && req.body.code) {
            ...
            try {
                this._stateStore.verify(req, state, (err, ok, state) => {
                    ...
                    oauth2.getOAuthAccessToken(code, params, (err, accessToken, refreshToken, params) => {
                        ...
                        const profile = { id: jwtClaims.sub, idToken: req.body.id_token };
            ...
            const params = {
                ...
                response_type: this._responseType.join(' '),
